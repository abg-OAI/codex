//! Model-facing adapter for `saffrodex.await_exec`.
...
const NAMESPACE: &str = "saffrodex";
const TOOL_NAME: &str = "await_exec";

/// Registers and executes the `saffrodex.await_exec` tool.
///
...
fn create_tool_spec() -> ToolSpec {
    ...
    ToolSpec::Namespace(ResponsesApiNamespace {
        ...
        description: "Saffrodex extensions for coordinating long-running exec_command sessions."
            .to_string(),
